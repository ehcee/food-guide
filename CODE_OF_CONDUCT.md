# Contributor Covenant Code of Conduct for a project hosted by Service Canada

([Français](#code-de-conduite-pour-un-projet-hébergé-par-service-canada))

Contributors to repositories hosted in Service Canada are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
# Code de conduite pour un projet hébergé par Service Canada
<!--markdownlint-enable MD025-->

([English](#contributor-covenant-code-of-conduct-for-a-project-hosted-by-service-canada))

Les contributeurs aux dépôts hébergés par Service Canada sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le [Code de valeurs et d'éthique du secteur public](https://www.tbs-sct.canada.ca/pol/doc-fra.aspx?id=25049).
